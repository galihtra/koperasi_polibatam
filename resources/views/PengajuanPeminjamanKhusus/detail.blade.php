                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-12">
                                <ul id="progressbar" class="text-center">
                                    <li class="{{ $loan->isStatusActiveOrPassed('Menunggu Pengawas') ? 'active' : '' }} step0">
                                    </li>
                                    <li class="{{ $loan->isStatusActiveOrPassed('Menunggu Bendahara') ? 'active' : '' }} step0">
                                    </li>
                                    <li class="{{ $loan->isStatusActiveOrPassed('Menunggu SDM') ? 'active' : '' }} step0">
                                    </li>
                                    <li class="{{ $loan->isStatusActiveOrPassed('Menunggu Kepala Bagian') ? 'active' : '' }} step0">
                                    </li>
                                    <li
                        ...
                        <div class="row justify-content-between top">
                            ...
                            <div class="row d-flex icon-content">
                                <img class="icon" src="/assets/img/verif_hr.png">
                                <div class="d-flex flex-column">
                                    <p class="font-weight-bold">Menunggu<br>SDM</p>
                                </div>
                            </div>
                            <div class="row d-flex icon-content">
                                <img class="icon" src="/assets/img/verif_head.png">
                                <div class="d-flex flex-column">
                                    <p class="font-weight-bold">Menunggu<br>Kepala Bagian</p>
                                </div>
                            </div>
                            <div class="row d-flex icon-content">
