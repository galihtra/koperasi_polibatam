        ...
        <div class="row">
          <div class="col-12 ">
            <div class="login-brand">
              <h2>FORMULIR PERMOHONAN PINJAMAN KONSUMTIF KHUSUS</h2>
            </div>
                  ...
                  <label for="data_pribadi">
                    <h6>
                      ...
                      <ul class="list-unstyled">
                        <li>1. Formulir ini ditujukan untuk pinjaman >10 s/d 300juta sesuai kondisi kas KPB yang akan diangsurkan maksimal 72 bulan</li>
                        <li>2. Formulir ini wajib dilengkapi dengan ijazah asli dan transkip nilai asli serta jaminan lain yang senilai dengan besaran pinjaman misalnya BPKB motor/mobil, dan sebagainya</li>
                      </ul>
                    </h6>
                    <br>
