                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @php
                                $riwayatCicilan = App\Models\CicilanPinjaman::where('id_pinjamanKhusus', $loan->id)->get();
                            @endphp
                            ...
                            <div class="form-group mt-4">
                                <a href="{{ route('pembayaran.khusus.mutasi') }}" class="btn btn-secondary">Kembali</a>
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('pembayaran.khusus.store') }}">
                                                ...
                                                <div class="form-group">
                                                    <input type="hidden" name="id_pinjamanKhusus" value="{{ $loan->id }}">
                                                </div>
                                                <div class="form-group">
