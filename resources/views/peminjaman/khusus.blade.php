                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('pinjaman.khusus.store') }}" enctype="multipart/form-data">
                                    ...
                                    <label for="data_pribadi">
                                        <h6>
                                            ...
                                            <ul class="list-unstyled">
                                                <li>1. Formulir ini ditujukan untuk pinjaman >10 s/d 300juta sesuai kondisi
                                                    kas KPB yang akan diangsurkan maksimal 72 bulan</li>
                                                <li>2. Formulir ini wajib dilengkapi dengan ijazah asli dan transkip nilai
                                                    asli serta jaminan lain yang senilai dengan besaran pinjaman misalnya
                                                    BPKB motor/mobil, dan sebagainya</li>
                                            </ul>
                                        </h6>
                                        <br>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-lg-6">
                                        <div class="form-group">
                                            <label for="besar_pinjaman">Besar Pinjaman (Minimum pinjaman 10 juta rupiah)<b class="text-danger">*</b></label>
